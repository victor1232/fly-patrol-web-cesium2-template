<template>
  <el-dialog v-model="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="dataFormRef" @keyup.enter="dataFormSubmitHandle()" label-width="120px">
      ...
      <el-form-item prop="isFlyer" :label="$t('user.isFlyer')" size="mini" required>
        <el-radio-group v-model="dataForm.isFlyer">
          <el-radio :label="1">{{ $t("user.isFlyer1") }}</el-radio>
          <el-radio :label="0">{{ $t("user.isFlyer0") }}</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-form>
